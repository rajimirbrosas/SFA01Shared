...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <layoutAssignments>
        <layout>Account-AE - Account Layout</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Account-AE - Account Layout</layout>
    ...
    <layoutAssignments>
        <layout>Account-Page Layout Read-Only Fields</layout>
    ...
    <layoutAssignments>
        <layout>Opportunity-AE - Opportunity Layout</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Opportunity-AE - Opportunity Layout</layout>
